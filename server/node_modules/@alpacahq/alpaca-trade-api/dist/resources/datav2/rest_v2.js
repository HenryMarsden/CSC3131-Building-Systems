...
function getDataV2(endpoint, path, options, config) {
    return __asyncGenerator(this, arguments, function* getDataV2_1() {
        ...
        while (true) {
            ...
            options = Object.assign(Object.assign({}, options), { limit: actualLimit, page_token: pageToken });
            const resp = yield __await(dataV2HttpRequest(`${path}`, options, config));
...
function getMultiDataV2(symbols, endpoint, options, config) {
    return __asyncGenerator(this, arguments, function* getMultiDataV2_1() {
        let pageToken = null;
        while (true) {
            const params = Object.assign(Object.assign({}, options), { symbols: symbols.join(","), limit: options.page_limit, page_token: pageToken });
...
function getBars(symbol, options, config) {
    return __asyncGenerator(this, arguments, function* getBars_1() {
        ...
        try {
            for (var bars_1 = __asyncValues(bars), bars_1_1; bars_1_1 = yield __await(bars_1.next()), !bars_1_1.done;) {
                const bar = bars_1_1.value;
            ...
            try {
                if (bars_1_1 && !bars_1_1.done && (_a = bars_1.return)) yield __await(_a.call(bars_1));
            }
